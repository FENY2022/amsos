...
// Array of dynamically changing bullet points
$bulletPoints = [
    "Boost efficiency and minimize delays.",
    "Ensure seamless compatibility with modern software.",
    "Enhance security by upgrading to supported operating systems.",
    "Lower maintenance costs and reduce technical issues.",
    "Improve overall system performance and reliability.",
    "Support new applications and workflows effectively.",
    "Reduce downtime caused by outdated hardware.",
    "Increase productivity with faster and more reliable equipment.",
    "Ensure data protection with up-to-date security measures."
];

// Randomly shuffle the bullet points and select 4 unique points
shuffle($bulletPoints);
$selectedPoints = array_slice($bulletPoints, 0, 4);
?>
...
<head>
    ...
    <title>Overall Equipment Replacement Report</title>
...
<body>
    <div class="container">
        <h2>Overall Equipment Replacement Report</h2>

        <div class="summary-box">
            <p><strong>Total Equipment Items Beyond 5 Years:</strong> <?php echo $beyond5YearsCount; ?></p>
        </div>

        <?php if ($beyond5YearsCount > 0): ?>
            <h4>Why Replacement is Necessary:</h4>
            <p>The following equipment has exceeded its useful lifespan. Replacing it will:</p>
            <ul>
                <?php foreach ($selectedPoints as $point): ?>
        ...
        <?php else: ?>
            <p>No equipment found that needs replacement.</p>
        <?php endif; ?>
    </div>
