    ...
    <td colspan="2" style="
        ...
        <?php echo $description; ?> </td>
                ...
                <tr>
                    ...
                    <tr>
                    <td>
                      <strong>Full Name: </strong><span style="font-weight: bold; font-size: medium;"><strong><?php echo " " . strtoupper($selectedName2);  ?></strong></span>
                    </td>
                ...
                <strong>Completed</strong>
                    ...
                    <div style="
                                ...
                                padding: 20px; 
                                background-color: transparent; 
                                background-image: url('https://otos.e-dats.info/forms/setEmployee/<?php echo $Signature_dir; ?>'); 
                                background-size: 60%; /* Adjusted size for compression */
                                background-repeat: no-repeat; 
                                background-position: 40% center; /* Adjust horizontal position */
                                border: 0px solid #000;
