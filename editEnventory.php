                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="employeeName">
                                    ...
                                    <?php
                                    $sqlEmp = "SELECT DISTINCT employeeName FROM inv_inventory WHERE employeeName IS NOT NULL AND employeeName != '' ORDER BY employeeName ASC";
                                    $resultEmp = $conn->query($sqlEmp);
                                    if ($resultEmp && $resultEmp->num_rows > 0) {
                                        while ($rowEmp = $resultEmp->fetch_assoc()) {
                                            $selected = ($employeeName == $rowEmp['employeeName']) ? 'selected' : '';
                                            echo "<option value='" . htmlspecialchars($rowEmp['employeeName']) . "' " . $selected . ">" . htmlspecialchars($rowEmp['employeeName']) . "</option>";
                                        }
                                    } else {
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="accountablePerson" required>
                                    <option value="">Select Employee</option>
                                    <?php
                                    $sqlAccountable = "SELECT DISTINCT accountablePerson FROM inv_inventory WHERE accountablePerson IS NOT NULL AND accountablePerson != '' ORDER BY accountablePerson ASC";
                                    ...
                                    if ($resultAccountable && $resultAccountable->num_rows > 0) {
                                        while ($rowAccountable = $resultAccountable->fetch_assoc()) {
                                            $selected = ($accountablePerson == $rowAccountable['accountablePerson']) ? 'selected' : '';
                                            echo "<option value='" . htmlspecialchars($rowAccountable['accountablePerson']) . "' " . $selected . ">" . htmlspecialchars($rowAccountable['accountablePerson']) . "</option>";
                                        }
                                    } else {
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <ul class="list-group" id="officeDivisionList">
                                                    <?php
                                                    $sqlDiv = "SELECT DISTINCT officeDivision FROM inv_inventory WHERE officeDivision IS NOT NULL AND officeDivision != '' ORDER BY officeDivision ASC";
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="actualUser" required>
                                    ...
                                    <?php
                                    $sqlActualUser = "SELECT DISTINCT actualUser FROM inv_inventory WHERE actualUser IS NOT NULL AND actualUser != '' ORDER BY actualUser ASC";
                                    ...
                                    if ($resultActualUser && $resultActualUser->num_rows > 0) {
                                        while ($rowActualUser = $resultActualUser->fetch_assoc()) {
                                            $selected = ($actualUser == $rowActualUser['actualUser']) ? 'selected' : '';
                                            echo "<option value='" . htmlspecialchars($rowActualUser['actualUser']) . "' " . $selected . ">" . htmlspecialchars($rowActualUser['actualUser']) . "</option>";
                                        }
                                    } else {
